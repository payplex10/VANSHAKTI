            ...
            <div className="position-relative d-flex justify-content-between flex-wrap" style={{ marginTop: "40px" }}>
              ...
              {collaborationSteps.map((step, idx) => (
                <div
                  ...
                  style={{ width: "18%", zIndex: 1 }}
                  data-aos="fade-up"
                  data-aos-delay={idx * 100}
                >
                  <div
                    onMouseEnter={(e) => {
                      e.currentTarget.style.backgroundColor = "#006B33";
                      e.currentTarget.style.border = "1px solid #006B33";
                      e.currentTarget.style.boxShadow = "0 6px 20px rgba(0,107,51,0.3)";
                    ...
                    onMouseLeave={(e) => {
                      ...
                      e.currentTarget.querySelector("img").style.filter =
                        idx === 4
                          ? "invert(28%) sepia(95%) saturate(500%) hue-rotate(109deg) brightness(85%)"
                          : "none";
                    }}
                    style={{
                      width: "70px",
                  ...
                  <div className="text-center">
                    <span style={{ fontSize: "0.85rem", fontWeight: 500, color: "#1c5a3e", display: "block", marginBottom: "4px" }}>
                      {step.title}
                    </span>
                    <p style={{ fontSize: "0.75rem", color: "#5d6b64", margin: 0, lineHeight: "1.3" }}>
                      {step.desc}
                    </p>
                  </div>
                </div>
