...
const About = () => {
  ...
  // Approaches box: mouseenter → lock page scroll + cursor pointer
  // mouseleave → restore scroll + cursor
  // wheel → change approach card only
  useEffect(() => {
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        html { overflow-y: scroll; } /* scrollbar always reserved — prevents layout shift */
        ...
        .vs-hero__badge {
          display: inline-block; border: 1px solid rgba(255,255,255,0.7); color: #fff;
          font-size: clamp(0.7rem, 1.5vw, 0.85rem); padding: 6px 20px; border-radius: 30px;
          font-family: 'DM Sans', sans-serif; margin-bottom: clamp(24px, 4vw, 56px);
        }
        .vs-hero__grid {
          display: grid; grid-template-columns: 1fr 1fr;
          align-items: end; gap: clamp(16px, 3vw, 40px);
        }
        .vs-hero__h1 {
          font-size: clamp(1.75rem, 4.5vw, 3.25rem); font-weight: 400;
          line-height: 1.1; color: #fff; font-family: 'DM Sans', sans-serif; margin: 0;
        }
        .vs-hero__p {
        ...
        .vs-why__h2 { font-size: clamp(1.75rem, 3.5vw, 2.5rem); font-weight: 400; line-height: 1.2; margin-bottom: 20px; font-family: 'DM Sans', sans-serif; }
        .vs-why__p { font-size: clamp(1rem, 1.8vw, 1.5rem); line-height: 1.55; color: #333; }
        ...
        .vs-connections {
          ...
          margin: clamp(16px, 3vw, 24px) 0; overflow: hidden;
        }
        ...
        .vs-connections__text {
          position: absolute; top: 50%; left: clamp(40px, 6vw, 80px);
          transform: translateY(-50%); max-width: clamp(300px, 45vw, 640px); color: #fff;
        }
        .vs-connections__text h2 { font-size: 56px; font-weight: 400; line-height: 1.35; font-family: 'DM Sans', sans-serif; margin: 0; }
        @media (max-width: 1024px) {
          .vs-connections__text { left: clamp(24px, 5vw, 60px); max-width: 60%; }
          .vs-connections__text h2 { font-size: clamp(1.3rem, 3.2vw, 2.2rem); }
        }
        @media (max-width: 768px) {
          .vs-connections { height: clamp(240px, 60vw, 360px); }
          .vs-connections__text { left: 16px; right: 16px; top: auto; bottom: clamp(24px, 6vw, 40px); transform: none; max-width: 100%; }
          .vs-connections__text h2 { font-size: 1.4rem; }
        }
        ...
        .vs-agri__img { width: 100%; height: auto; max-width: 500px; border-radius: 12px; object-fit: cover; display: block; }
      ...
      <div style={{ fontFamily: "'DM Sans', sans-serif", overflowX: "hidden" }}>
          ...
          <div className="vs-hero__inner">
            ...
            <div className="vs-hero__grid">
              <Reveal direction="up" delay={0.15}>
                <h1 className="vs-hero__h1">Rooted in Agriculture.<br />Built for the Future.</h1>
              </Reveal>
            ...
            <Reveal direction="left" delay={0.1}>
              <div className="vs-img-grid">
                <div className="vs-img-col">
                  <motion.img src={farmImages[0]} alt="Farm field" className="vs-img-tall" initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, ease: "easeOut" }} viewport={{ once: true }} />
                  <motion.img src={farmImages[2]} alt="Farm harvest" className="vs-img-short" initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.2, ease: "easeOut" }} viewport={{ once: true }} />
                </div>
                <div className="vs-img-col">
                  <motion.img src={farmImages[1]} alt="Farmland" className="vs-img-short" initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.1, ease: "easeOut" }} viewport={{ once: true }} />
                  <motion.img src={farmImages[3]} alt="Farm produce" className="vs-img-tall" initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.3, ease: "easeOut" }} viewport={{ once: true }} />
                </div>
              </div>
            </Reveal>
          </div>
        ...
        <section className="vs-connections" aria-label="Building connections">
          ...
          <div className="vs-connections__text">
            <h2 style={{ fontSize: "56px", fontWeight: 400 }}>
              Building stronger connections across agriculture.
            </h2>
          </div>
        </section>
        ...
        <section className="vs-agri" aria-label="Integrated Approach to Agriculture">
          <div className="vs-agri__inner">
            ...
            {/* RIGHT — fixed heading + slider + dots */}
            <div style={{ display: "flex", flexDirection: "column", height: "100%", justifyContent: "flex-start" }}>

              {/* FIXED HEADING */}
              <h2 style={{
                fontSize: "clamp(1.5rem, 2.8vw, 2.2rem)", fontWeight: 400, lineHeight: 1.2,
                color: "#1F1F1F", fontFamily: "'DM Sans', sans-serif",
                marginBottom: "clamp(20px, 3vw, 36px)", marginTop: 0,
              }}>
                An Integrated Approach<br />to Agriculture
              </h2>

              {/* SLIDER + DOTS ROW */}
              <div style={{ display: "flex", alignItems: "stretch", gap: "16px", flex: 1 }}>

                {/* Native div — sliderRef for wheel listener */}
                <div
                  ref={sliderRef}
                  style={{
                    flex: 1, minHeight: "220px", overflow: "hidden",
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      >
                        <div style={{
                          ...
                          background: "#1D5B46", color: "#fff",
                          display: "flex", alignItems: "center", justifyContent: "center",
                          fontWeight: 600, fontSize: "14px", marginBottom: "16px",
                        }}>
                          0{currentIndex + 1}
                        </div>
                        <h3 style={{ fontSize: "22px", fontWeight: "600", color: "#1D5B46", margin: 0 }}>
                          {approaches[currentIndex].title}
                        </h3>
                        <p style={{ color: "#555", marginTop: "12px", lineHeight: 1.7 }}>
                ...
                <div style={{
                  ...
                  {approaches.map((_, idx) => (
                    <button
                      ...
                      style={{
                        width: currentIndex === idx ? "10px" : "8px",
                        height: currentIndex === idx ? "28px" : "8px",
                        borderRadius: "999px",
                        background: currentIndex === idx ? "#1D5B46" : "#C8D9D3",
